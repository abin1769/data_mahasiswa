                    ...
                    <div class="card-body p-4">
                        <form action="helper/update.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="program_studi" name="prodi" value="<?php echo $data['prodi']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="tanggal_lahir" class="form-label">DATE</label>
                                <input type="date" id="tanggal_lahir" class="form-control" name="tanggal_lahir" value="<?php echo $data['tanggal_lahir']; ?>" required>
                            </div>
                            <div class="d-grid">
